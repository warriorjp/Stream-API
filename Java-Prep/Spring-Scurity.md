...
We generate the two tokens -
1. Access-Tocken - to access the apis
2. Refresh-Tocken - to regenerate the access token and refresh token to keep the user logged in.

    We have an expiry of the token of 15 mins.
...
----------------------------------------------------------------------------------------------------------
✅ 2. JWT Utility to Generate and Validate Token
...
----------------------------------------------------------------------------------------------------------
✅ Bonus: Authentication Controller :
